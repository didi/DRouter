...
abstract class RouterTransform @Inject constructor(
    private val bootClasspath: ListProperty<RegularFile>,
    ...
    fun taskAction() {
        ...
        // 入口
        RouterTask(assembleClassPath(), mutableSetOf(), false, routerDir).run(bootClasspath)
